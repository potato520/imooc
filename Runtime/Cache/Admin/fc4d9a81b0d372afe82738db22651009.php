...
<body>
	<div id="pageAll">
  	  ...
  	  <form action="/index.php/Admin/Article/mod" enctype="multipart/form-data"  method="post">
				...
				<div class="baBody">
					...
					<div class="bbD">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;缩略图：　　<input type="file"
							...
							<?php if($data['thumb'] != '' ): ?><img src="/<?php echo ($data["thumb"]); ?>" alt="" id="preview" style="float:right;" width="100" height="100" />
							<?php else: ?>
...
<script type="text/javascript" src="/Public/Admin/js/showPic.js"></script>
