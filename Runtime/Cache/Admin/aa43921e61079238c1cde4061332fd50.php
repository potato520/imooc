...
<body>
	...
	<script type="text/javascript">
			window.jQuery || document.write("<script src='/imooc/Public/Admin/Ace/assets/js/jquery-2.0.3.min.js'>"+"<"+"/script>");</script>
 ...
 window.jQuery || document.write("<script src='assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");</script>
	...
	<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='/imooc/Public/Admin/Ace/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");</script>

	<script src="/imooc/Public/Admin/Ace/assets/js/bootstrap.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/typeahead-bs2.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/jquery.ui.touch-punch.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/chosen.jquery.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/fuelux/fuelux.spinner.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/date-time/bootstrap-datepicker.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/date-time/bootstrap-timepicker.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/date-time/moment.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/date-time/daterangepicker.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/bootstrap-colorpicker.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/jquery.knob.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/jquery.autosize.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/jquery.inputlimiter.1.3.1.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/jquery.maskedinput.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/bootstrap-tag.min.js"></script>

	<!-- ace scripts -->	

	<script src="/imooc/Public/Admin/Ace/assets/js/ace-elements.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/assets/js/ace.min.js"></script>
	<script src="/imooc/Public/Admin/Ace/mustache\app\views\assets\scripts\form-elements.js"></script>

	<!-- 上传图片插件结束 -->	

	<!-- 百度编辑器开始 -->	
	<script type="text/javascript" charset="utf-8" src="/imooc/Public/Admin/ueditor/ueditor.config.js"></script>
	<script type="text/javascript" charset="utf-8" src="/imooc/Public/Admin/ueditor/ueditor.all.min.js"></script>
	<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->	
	<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->	
	<script type="text/javascript" charset="utf-8" src="/imooc/Public/Admin/ueditor/lang/zh-cn/zh-cn.js"></script>
	<!-- 百度编辑器结束 -->	

	<!-- 时间控件star -->	
	<script src="/imooc/Public/Admin/laydate/laydate.js"></script>
	<!-- 时间控件end -->	
	...
	<div class="widget-box">
		...
		<div class="widget-body">
			<div class="widget-main no-padding">
				<!-- PAGE CONTENT BEGINS -->	
				<form action="/imooc/index.php/Admin/Article/add" enctype="multipart/form-data"  method="post" class="form-horizontal" role="form">
					<br>	
