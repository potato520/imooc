					...
					<table id="sample-table-1" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td>
										<?php if($vo["userpic"] != '' ): ?><img src="/<?php echo ($vo["userpic"]); ?>" alt="pic" width="50">	
											<?php else: ?>	
											<img src="/Uploads/576557763724d.jpg" alt="defPic" width="50"><?php endif; ?>
									</td>
									...
									<td >
										<?php if($vo['name'] == C('RBAC_SUPPERADMIN') ): ?>超级管理员
										<?php else: ?>	
										<?php echo ($vo["name"]); ?>(<?php echo ($vo["remark"]); ?>)<?php endif; ?>
								</td>
