...
<body>
	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->	
				<form action="/imooc/index.php/Admin/Category/mod" enctype="multipart/form-data"  method="post" class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text"  id="form-field-1" placeholder="分类名称" class="col-xs-10 col-sm-5" name="name" value="<?php echo ($finData['name']); ?>" />	
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" id="form-field-2" placeholder="别名" class="col-xs-10 col-sm-5"  name="nickname" value="<?php echo ($finData['nickname']); ?>" />	
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input class="input-sm" type="text" id="form-field-3" placeholder="排序" name="sort"  value="<?php echo ($finData['sort']); ?>" />	
