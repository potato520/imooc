...
<script type="text/javascript" src="/video/Public/Admin/js/jquery.min.js"></script>
  ...
  <script type="text/javascript" charset="utf-8" src="/video/Public/Admin/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/video/Public/Admin/ueditor/ueditor.all.min.js"> </script>
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="utf-8" src="/video/Public/Admin/ueditor/lang/zh-cn/zh-cn.js"></script>
...
<body>
	<div id="pageAll">
  	  ...
  	  <form action="/video/index.php/Admin/Article/mod" enctype="multipart/form-data"  method="post">
				...
				<div class="baBody">
					...
					<div class="bbD">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;缩略图：　　<input type="file"
							...
							<?php if($data['thumb'] != '' ): ?><img src="/video/<?php echo ($data["thumb"]); ?>" alt="" id="preview" style="float:right;" width="100" height="100" />
							<?php else: ?>
