...
<body>
	<div id="pageAll">
  	  ...
  	  <form action="/video/index.php/Admin/Article/add" enctype="multipart/form-data"  method="post">
				<div class="baBody">
...
　　　
					...
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;内容：　　
						<textarea name="content" id="content" style="width:1000px; height:500px;margin-left:107px;"></textarea>
					</div>
