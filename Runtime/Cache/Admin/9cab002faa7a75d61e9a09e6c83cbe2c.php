...
<script>
	$(function(){
		$("#addBtn").click(function(){
			window.location.href="/video/index.php/Admin/Course/add";
		})
	})
</script>
...
<!-- 获取要修改的id值  [ 尤开利 ] -->
	...
	$(function(){
		$("tr #modBtn").click(function(){
    		...
    		// alert(id);
    		window.location.href="/video/index.php/Admin/Course/mod/id/" + id;
		})
	...
	$(function(){
		$("tr #delBtn").click(function(){
    		var id = $(this).attr("ids");
    		// alert(id);
    		window.location.href="/video/index.php/Admin/Course/del/id/" + id;
		})
...
<div class="banDel">
	<div class="delete">
		...
		<p class="delP2">
			<a href="/video/index.php/Admin/Course/del/id/123" class="ok yes">确定</a>
			<a class="ok no">取消</a>
		</p>
	</div>
</div>
...
$(".delban").click(function(){
	...
	$(".yes").attr("href", "/video/index.php/Admin/Course/del/id/" + id);
    $(".banDel").show();
});
