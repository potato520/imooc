...
<body>
	...
	!function(){
		var infoWindow, map, level = 16,
			center = {lng: 116.368462, lat: 39.941692},
			features = [{type: "Polygon", name: "北京市新街口工行支行", desc: "老地方，老的朋友", strokeWeight: 2, strokeColor: "#F0202F", strokeOpacity: 0.8, fillColor: "red", fillOpacity:0.2, lnglat: [{lng: 116.367861, lat: 39.941626}, {lng: 116.367882, lat: 39.94077}, {lng: 116.368977, lat: 39.940787}, {lng: 116.368977, lat: 39.941642}]},
				{type: "Marker", name: "老地方", desc: "老地方，老朋友", color: "green", icon: "cir", offset: {x: -9, y: -31}, lnglat: {lng: 116.368548, lat: 39.94133}}];
