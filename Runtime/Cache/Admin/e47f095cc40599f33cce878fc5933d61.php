...
<title>行家添加-有点</title>
<link rel="stylesheet" type="text/css" href="/imooc/Public/Admin/css/css.css" />
<script type="text/javascript" src="/imooc/Public/Admin/js/jquery.min.js"></script>
...
<body>
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="/imooc/Public/Admin/img/coin02.png" /><span><a href="#">首页</a>&nbsp;-&nbsp;<a
  	  ...
  	  <form action="/imooc/index.php/Admin/Article/mod" enctype="multipart/form-data"  method="post">
				...
				<div class="baBody">
					...
					<div class="bbD">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;缩略图：　　<input type="file"
							...
							<?php if($data['thumb'] != '' ): ?><img src="/imooc/<?php echo ($data["thumb"]); ?>" alt="" id="preview" style="float:right;" width="100" height="100" />
							<?php else: ?>
...
<script type="text/javascript" src="/imooc/Public/Admin/js/showPic.js"></script>
