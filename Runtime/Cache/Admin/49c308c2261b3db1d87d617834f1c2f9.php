...
<body>
					...
					<table id="sample-table-1" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td>
										<?php if($vo["userpic"] != '' ): ?><img src="/imooc/<?php echo ($vo["userpic"]); ?>" alt="pic" width="50">	
											<?php else: ?>	
											<img src="/imooc/Uploads/576557763724d.jpg" alt="defPic" width="50"><?php endif; ?>
									</td>
	...
	<script>
		...
		$(".btn-info").on("click", function(){
			...
			window.location.href="/imooc/index.php/Admin/User/mod/id/" + id;
		});
	</script>