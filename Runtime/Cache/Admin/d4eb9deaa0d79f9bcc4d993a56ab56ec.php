	...
	<div class="widget-box">
		...
		<div class="widget-body">
			<div class="widget-main no-padding">
				<!-- PAGE CONTENT BEGINS -->	
				<form action="/index.php/Admin/Rbac/addRole" enctype="multipart/form-data"  method="post" class="form-horizontal" role="form">
	<br>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text"  id="form-field-1" placeholder="角色名称" class="col-xs-10 col-sm-5" name="name" />	
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-4 control-label no-padding-right" for="form-field-2">角色描述</label>

						<div class="col-sm-7">
							<input type="text" id="form-field-2" placeholder="角色描述" class="col-xs-10 col-sm-5"  name="remark" />	
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							开启：<input type="radio" id="form-field-3" placeholder="确认密码" name="status" value="1" checked="checked" />	关闭：
							<input type="radio" id="form-field-3" placeholder="确认密码" name="status" value="0" />	
