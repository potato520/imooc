...
<body>
 ...
 window.jQuery || document.write("<script src='assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");</script>
	...
	<style>
		.add-role{display: inline-block;width: 100px;height: 28px; line-height: 28px; text-align: center;border: solid 1px blue; border-radius: 4px; cursor: pointer;}
	</style>
	...
	<div class="widget-box">
		...
		<div class="widget-body">
			<div class="widget-main no-padding">
				<!-- PAGE CONTENT BEGINS -->	
				<form action="/index.php/Admin/Rbac/addUser" enctype="multipart/form-data"  method="post" class="form-horizontal" role="form">
					<br>	
					...
					<div class="form-group">
						<label class="col-sm-4 control-label no-padding-right" for="form-field-select-7">所属角色</label>

						<div class="col-sm-3">
							<select class="form-control" name="role_id" id="form-field-select-7">
							<option value="">请选择角色</option>
								<?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>">
										<?php echo ($vo["name"]); ?>(<?php echo ($vo["remark"]); ?>)
