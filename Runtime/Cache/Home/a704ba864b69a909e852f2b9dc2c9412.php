...
<div id="main">
    ...
    <div class="container">
<form id="filterForm" name="form1" method="get" action="/index.php/Home/Course/index">
            ...
            <div class="course-nav-box">
                ...
                <div class="course-nav-row clearfix">
                    ...
                    <div class="bd">
                        <ul class="">
                            <li class="course-nav-item ">
                                <a href="javascript:Filter('cid','0');">全部</a>
                            </li>
                    ...
                    <div class="bd">
                        <ul class="">
                            <li class="course-nav-item  on">
                                <a href="javascript:Filter('status','0');">全部</a>
                            </li>
                            <li class="course-nav-item ">
                                <a href="javascript:Filter('status','1');">初级</a>
                            </li>
                            <li class="course-nav-item ">
                                <a href="javascript:Filter('status','2');">中级</a>
                            </li>
                            <li class="course-nav-item ">
                                <a href="javascript:Filter('status','3');">高级</a>
                            </li>
                        </ul>
                    </div>
                </div>
