            ...
            <div class="course-nav-box">
                    ...
                    <div class="bd">
                        <ul class="" id="fx">
                            <li class="course-nav-item">
                                <a href="/imooc/index.php/Home/Course/list2/s/html">全部</a>
                            </li>
                           <?php if(is_array($currOne)): $i = 0; $__LIST__ = $currOne;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="course-nav-item 
                            ...
                            ">
                                <a href="/imooc/index.php/Home/Course/list2/s/<?php echo ($v["nickname"]); ?>" data-id=7 data-ct=fe><?php echo ($v["name"]); ?></a>
                ...
                <div class="course-nav-row clearfix">
                    ...
                    <div class="bd">
                        <ul class="">
                            <li class="course-nav-item">
                                <a href="/imooc/index.php/Home/Course/list2/s/<?php echo ($catAll); ?>">全部</a>
                            </li>
                            ...
                            ">
                                ...
                                <a href="/imooc/index.php/Home/Course/cat/s/<?php echo ($v["nickname"]); ?>" data-id=7 data-ct=fe><?php echo ($v["name"]); ?></a>
                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                    ...
                    <script>
                            function load(a){
                               // alert(a);
                                $.get("/imooc/index.php/Home/Course/cat/s/"+a, function(data) {
                                      //修改未读消息的提示
                                    alert(data)
                                })
                            }
